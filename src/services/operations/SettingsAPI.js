...
export function updateProfile(token, formData) {
  return async (dispatch) => {
    ...
    try {
      ...
      // Check if firstName is present in updatedUserDetails, if not, use a default value
      const firstName = updatedUserDetails.firstName || 'User';
      const lastName = updatedUserDetails.lastName || 'Name';
