...
export default function RecipesTable({ recipes, setRecipes }) {
  ...
  const handleRecipeDelete = async (recipeId) => {
    setLoading(true)
    await deleteRecipe({ recipeId: recipeId }, token)
              ...
              >
                <Td className="flex flex-1 gap-x-4">
                  ...
                  <div className="flex flex-col justify-between">
                    ...
                    <p className="text-xs text-richblack-300">
                      {recipe.recipeDescription.split(" ").length >
                      TRUNCATE_LENGTH
                ...
                <Td className="text-sm font-medium text-richblack-100 ">
                  <button
                    disabled={loading}
                    onClick={() => {
                      navigate(`/dashboard/edit-recipe/${recipe._id}`)
                    }}
                    title="Edit"
                  ...
                  <button
                    ...
                    onClick={() => {
                      setConfirmationModal({
                        text1: "Do you want to delete this recipe?",
                        text2:
                          "All the data related to this recipe will be deleted",
